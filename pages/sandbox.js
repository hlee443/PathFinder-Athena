    ...
    return (
        <Flexbox>
            ...
            <Wrapper>
                ...
                <TabBar></TabBar>
                <URLbox dir="row">
                    <Input border="none" borderRadius="3.125rem 0 0 3.125rem;" width="100%" ></Input>
                    <Button borderRadius="0 3.125rem 3.125rem 0;" text="Customize" icon_name="chevronDown" type="IconButton" />
                </URLbox>
