  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>Athena v.0.2</h1>

        <p className={styles.description}>&quot;Live-ing with Hermes&quot;</p>
        ...
        <div className={styles.grid}>
          ...
          <a href="./test/dictionary" className={styles.card}>
            <h2>Dictionary &rarr;</h2>
            <p>Test the Dictionary API.</p>
          </a>

          <a href="./test/upload_test" className={styles.card}>
            <h2>Upload &rarr;</h2>
            <p>Test the Upload function.</p>
          </a>

          <a href="./test/db_test" className={styles.card}>
            <h2>Database &rarr;</h2>
